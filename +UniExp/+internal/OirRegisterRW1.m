classdef OirRegisterRW1<ParallelComputing.IBlockRWer
	...
	methods
		function obj = OirRegisterRW1(OirPath,BlockSize,WriteToCache,CacheDirectory)
			...
			obj.CollectData=struct(DeviceColors=DeviceColors,SeriesInterval=obj.Reader.SeriesInterval,LaserTransmissivity=obj.Reader.LaserTransmissivity,PmtVoltage=obj.Reader.PmtVoltage,CreationDateTime=obj.Reader.CreationDateTime,ConcatenateSizeT=obj.Reader.ConcatenateSizeT);
